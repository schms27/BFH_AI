...
def createArgs(args):
    ...
    parser.add_argument('--learning_rate', type=float, default=0.000649)
    parser.add_argument('--replay_buffer_size', type=int, default=2472)
    parser.add_argument('--replay_buffer_coldrun', type=int, default=197)
    parser.add_argument('--epsilon_max', type=float, default=0.9996)
    parser.add_argument('--epsilon_min', type=float, default=0.0377)
